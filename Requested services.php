                        ...
                        <div class="col-md-12 mt-md-0 mt-3 text-center">
                            <p class="text-danger text-center">
                                <?php if (($result['submitCount'])) {
                                    ...
                                    echo 'Form already submitted, please contact <span class="text-primary"><a href="mailto:selfpublish@s4carlisle.com" target="_blank" >selfpublish@s4carlisle.com</a></span> for updates."';
                                   
                                } 
                                else
                                { 
                                    echo 'If any query, please contact <span class="text-primary"><a href="mailto:selfpublish@s4carlisle.com" target="_blank" >selfpublish@s4carlisle.com</a></span>.';
                                }?>
                            </p>
                        </div>
                    </div>
