            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <label class="option">
                                <input type="radio" name="dimenSpecifications" value="Yes">Yes
                                <span class="checkmark"></span>
                            </label>
                            <label class="option ms-4">
                                <input type="radio" name="dimenSpecifications" value="No">No
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="text-danger" id="dimenSpecificationsErr"></div>
                        <br>
