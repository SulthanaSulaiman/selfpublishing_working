            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    ...
                    <label>Requested Services<span class="text-danger">*</span></label>
                        ...
                        <textarea class="form-control" id="spineText" name="spineText" rows="3" readonly="readonly" data-toggle="tooltip"
                            data-placement="top"
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <label>Author Selected Template<span
